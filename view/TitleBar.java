...
import controler.TitleBarControler;
...
public class TitleBar extends JPanel {
	...
	private void initComponent() throws IOException{
		...
		panFinal2.setBackground(new Color(0,76,153));
		panFinal.setBackground(new Color(0,76,153));		
		...
		exit.addActionListener(new TitleBarControler(this));		
	}
